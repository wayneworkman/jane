...
<style>
div{width:250px;padding:10px;border:5px solid gray;margin:0}
</style>
...
<form action="ad.php" method="post">
    ...
    <span style="color:blue;" title="SettingsNickName
        ...
        <input type="text" name="SettingsNickName" value="<?php echo ($_REQUEST['SettingsNickName']); ?>"></br>
...
<span style="color:blue;" title="SettingsPassword
        ...
        <input type="text" name="SettingsPassword" value="<?php echo ($_REQUEST['SettingsPassword']); ?>"></br>
...
<br>
    ...
    <div>
        ...
        <input type="text" name="AccountExpirationDate" value="<?php echo ($_REQUEST['AccountExpirationDate']); ?>"><br>
    </div>
    <div>
	...
	<?php if ($_REQUEST[''] == 1 ) { echo " checked"; }?>
	<input type="radio" name="AccountNotDelegated" value="1"<?php if ($_REQUEST['AccountNotDelegated'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="AccountNotDelegated" value="0"<?php if ($_REQUEST['AccountNotDelegated'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="AccountNotDelegated" value=""<?php if ($_REQUEST['AccountNotDelegated'] == "" ) { echo " checked"; }?>>Not Specified<br>
    ...
    <div>
        ...
        <input type="text" name="AccountPassword" value="<?php echo ($_REQUEST['AccountPassword']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="AllowReversiblePasswordEncryption" value="1"<?php if ($_REQUEST['AllowReversiblePasswordEncryption'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="AllowReversiblePasswordEncryption" value="0"<?php if ($_REQUEST['AllowReversiblePasswordEncryption'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="AllowReversiblePasswordEncryption" value=""<?php if ($_REQUEST['AllowReversiblePasswordEncryption'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
        ...
        <input type="text" name="AuthType" value="<?php echo ($_REQUEST['AuthType']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="CannotChangePassword" value="1"<?php if ($_REQUEST['CannotChangePassword'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="CannotChangePassword" value="0"<?php if ($_REQUEST['CannotChangePassword'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="CannotChangePassword" value=""<?php if ($_REQUEST['CannotChangePassword'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
        ...
        <input type="text" name="Certificates" value="<?php echo ($_REQUEST['Certificates']); ?>"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Company" value="<?php echo ($_REQUEST['Company']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Country" value="<?php echo ($_REQUEST['Country']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Credential" value="<?php echo ($_REQUEST['Credential']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Department" value="<?php echo ($_REQUEST['Department']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Description" value="<?php echo ($_REQUEST['Description']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="DisplayName" value="<?php echo ($_REQUEST['DisplayName']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Division" value="<?php echo ($_REQUEST['Division']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmailAddress" value="<?php echo ($_REQUEST['EmailAddress']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmployeeID" value="<?php echo ($_REQUEST['EmployeeID']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmployeeNumber" value="<?php echo ($_REQUEST['EmployeeNumber']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="Enabled" value="1"<?php if ($_REQUEST['Enabled'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="Enabled" value="0"<?php if ($_REQUEST['Enabled'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="Enabled" value=""<?php if ($_REQUEST['Enabled'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
        ...
        <input type="text" name="Fax" value="<?php echo ($_REQUEST['Fax']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="GivenName" value="<?php echo ($_REQUEST['GivenName']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomeDirectory" value="<?php echo ($_REQUEST['HomeDirectory']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomeDrive" value="<?php echo ($_REQUEST['HomeDrive']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomePage" value="<?php echo ($_REQUEST['HomePage']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomePhone" value="<?php echo ($_REQUEST['HomePhone']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Initials" value="<?php echo ($_REQUEST['Initials']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Instance" value="<?php echo ($_REQUEST['Instance']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="LogonWorkstations" value="<?php echo ($_REQUEST['LogonWorkstations']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Manager" value="<?php echo ($_REQUEST['Manager']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="MobilePhone" value="<?php echo ($_REQUEST['MobilePhone']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Office" value="<?php echo ($_REQUEST['Office']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="OfficePhone" value="<?php echo ($_REQUEST['OfficePhone']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Organization" value="<?php echo ($_REQUEST['Organization']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="OtherAttributes" value="<?php echo ($_REQUEST['OtherAttributes']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="OtherName" value="<?php echo ($_REQUEST['OtherName']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="PassThru" value="<?php echo ($_REQUEST['PassThru']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="PasswordNeverExpires" value="1"<?php if ($_REQUEST['PasswordNeverExpires'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="PasswordNeverExpires" value="0"<?php if ($_REQUEST['PasswordNeverExpires'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="PasswordNeverExpires" value=""<?php if ($_REQUEST['PasswordNeverExpires'] == "" ) { echo " checked"; }?>>Not Specified<br>
    ...
    <div>
        ...
        <input type="radio" name="PasswordNotRequired" value="1"<?php if ($_REQUEST['PasswordNotRequired'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="PasswordNotRequired" value="0"<?php if ($_REQUEST['PasswordNotRequired'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="PasswordNotRequired" value=""<?php if ($_REQUEST['PasswordNotRequired'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
        ...
        <input type="text" name="Path" value="<?php echo ($_REQUEST['Path']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="POBox" value="<?php echo ($_REQUEST['POBox']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="PostalCode" value="<?php echo ($_REQUEST['PostalCode']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="ProfilePath" value="<?php echo ($_REQUEST['ProfilePath']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="SamAccountName" value="<?php echo ($_REQUEST['SamAccountName']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="ScriptPath" value="<?php echo ($_REQUEST['ScriptPath']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Server" value="<?php echo ($_REQUEST['Server']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="ServicePrincipalNames" value="<?php echo ($_REQUEST['ServicePrincipalNames']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="SmartcardLogonRequired" value="1"<?php if ($_REQUEST['SmartcardLogonRequired'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="SmartcardLogonRequired" value="0"<?php if ($_REQUEST['SmartcardLogonRequired'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="SmartcardLogonRequired" value=""<?php if ($_REQUEST['SmartcardLogonRequired'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="StreetAddress" value="<?php echo ($_REQUEST['StreetAddress']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Surname" value="<?php echo ($_REQUEST['Surname']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Title" value="<?php echo ($_REQUEST['Title']); ?>"><br>
    </div>
    <div>
        ...
        <input type="radio" name="TrustedForDelegation" value="1"<?php if ($_REQUEST['TrustedForDelegation'] == 1 ) { echo " checked"; }?>>True<br>
        <input type="radio" name="TrustedForDelegation" value="0"<?php if ($_REQUEST['TrustedForDelegation'] == 0 ) { echo " checked"; }?>>False<br>
        <input type="radio" name="TrustedForDelegation" value=""<?php if ($_REQUEST['TrustedForDelegation'] == "" ) { echo " checked"; }?>>Not Specified<br>
    </div>
    <div>
        ...
        <input type="text" name="Type" value="<?php echo ($_REQUEST['Type']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="UserPrincipalName" value="<?php echo ($_REQUEST['UserPrincipalName']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="Confirm" value="<?php echo ($_REQUEST['Confirm']); ?>"><br>
    </div>
    <div>
        ...
        <input type="text" name="WhatIf" value="<?php echo ($_REQUEST['WhatIf']); ?>"><br>
    </div>
    <p><p><p>
