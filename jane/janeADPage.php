...
<div>
        ...
        Create when <input type="text" name="ActionCreate" value="<?php echo htmlspecialchars($_SESSION['ActionCreate']); ?>" style="width:300px;"> equals <input type="text" name="ActionCreateText" value="<?php echo ($_SESSION['ActionCreateText']); ?>" style="width:300px;"></br>
        Disable when <input type="text" name="ActionDisable" value="<?php echo htmlspecialchars($_SESSION['ActionDisable']); ?>" style="width:300px;"> equals <input type="text" name="ActionDisableText" value="<?php echo ($_SESSION['ActionDisableText']); ?>" style="width:300px;"></br>
        Delete when <input type="text" name="ActionDelete" value="<?php echo htmlspecialchars($_SESSION['ActionDelete']); ?>" style="width:300px;"> equals <input type="text" name="ActionDeleteText" value="<?php echo ($_SESSION['ActionDeleteText']); ?>" style="width:300px;"></br>
    </div>
...
<input type="radio" name="CreateFolder" value=""<?php if ($_SESSION['CreateFolder'] == "" ) { echo " checked"; }?>>Not Specified<br><br>
	...
	<input type="text" name="BaseDirectory" value="<?php echo htmlspecialchars($_SESSION['BaseDirectory']); ?>" style="width:600px;"><br>
	...
	<span style="color:blue;" title="Folder Name
        ...
        <input type="text" name="FolderName" value="<?php echo htmlspecialchars($_SESSION['FolderName']); ?>" style="width:600px;"><input type="checkbox" name="ShareThisFolder" value="1" <?php if ($_SESSION['ShareThisFolder'] == "1" ) { echo " checked"; }?>>
	...
	<input type="text" name="aclOther" value="<?php echo htmlspecialchars($_SESSION['aclOther']); ?>" style="width:600px;"></br>
...
<div>
	...
	Group 1 Name
        ...
        <input type="text" name="Group1Name" value="<?php echo htmlspecialchars($_SESSION['Group1Name']); ?>" style="width:600px;"></br>
    </div>
...
<div>
        ...
        <input type="text" name="Group2Name" value="<?php echo htmlspecialchars($_SESSION['Group2Name']); ?>" style="width:600px;"></br>
    </div>
...
<div>
        ...
        <input type="text" name="Group3Name" value="<?php echo htmlspecialchars($_SESSION['Group3Name']); ?>" style="width:600px;"></br>
    </div>
...
<div>
        ...
        <input type="text" name="RemoveFromGroups" value="<?php echo htmlspecialchars($_SESSION['RemoveFromGroups']); ?>" style="width:600px;"></br>
    </div>
...
<div>
    ...
    <div>
        ...
        <input type="text" name="AccountExpirationDate" value="<?php echo htmlspecialchars($_SESSION['AccountExpirationDate']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="AuthType" value="<?php echo htmlspecialchars($_SESSION['AuthType']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Certificates" value="<?php echo htmlspecialchars($_SESSION['Certificates']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="City" value="<?php echo htmlspecialchars($_SESSION['City']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Company" value="<?php echo htmlspecialchars($_SESSION['Company']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Credential" value="<?php echo htmlspecialchars($_SESSION['Credential']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Department" value="<?php echo htmlspecialchars($_SESSION['Department']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Description" value="<?php echo htmlspecialchars($_SESSION['Description']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="DisplayName" value="<?php echo htmlspecialchars($_SESSION['DisplayName']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Division" value="<?php echo htmlspecialchars($_SESSION['Division']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmailAddress" value="<?php echo htmlspecialchars($_SESSION['EmailAddress']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmployeeID" value="<?php echo htmlspecialchars($_SESSION['EmployeeID']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="EmployeeNumber" value="<?php echo htmlspecialchars($_SESSION['EmployeeNumber']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Fax" value="<?php echo htmlspecialchars($_SESSION['Fax']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="GivenName" value="<?php echo htmlspecialchars($_SESSION['GivenName']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomeDirectory" value="<?php echo htmlspecialchars($_SESSION['HomeDirectory']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomeDrive" value="<?php echo htmlspecialchars($_SESSION['HomeDrive']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomePage" value="<?php echo htmlspecialchars($_SESSION['HomePage']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="HomePhone" value="<?php echo htmlspecialchars($_SESSION['HomePhone']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Initials" value="<?php echo htmlspecialchars($_SESSION['Initials']); ?>" style="width:300px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Instance" value="<?php echo htmlspecialchars($_SESSION['Instance']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="LogonWorkstations" value="<?php echo htmlspecialchars($_SESSION['LogonWorkstations']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Manager" value="<?php echo htmlspecialchars($_SESSION['Manager']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="MobilePhone" value="<?php echo htmlspecialchars($_SESSION['MobilePhone']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Office" value="<?php echo htmlspecialchars($_SESSION['Office']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="OfficePhone" value="<?php echo htmlspecialchars($_SESSION['OfficePhone']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Organization" value="<?php echo htmlspecialchars($_SESSION['Organization']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="OtherAttributes" value="<?php echo htmlspecialchars($_SESSION['OtherAttributes']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="OtherName" value="<?php echo htmlspecialchars($_SESSION['OtherName']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="PassThru" value="<?php echo htmlspecialchars($_SESSION['PassThru']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Path" value="<?php echo htmlspecialchars($_SESSION['Path']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="POBox" value="<?php echo htmlspecialchars($_SESSION['POBox']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="PostalCode" value="<?php echo htmlspecialchars($_SESSION['PostalCode']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="ProfilePath" value="<?php echo htmlspecialchars($_SESSION['ProfilePath']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="ScriptPath" value="<?php echo htmlspecialchars($_SESSION['ScriptPath']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Server" value="<?php echo htmlspecialchars($_SESSION['Server']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="ServicePrincipalNames" value="<?php echo htmlspecialchars($_SESSION['ServicePrincipalNames']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="State" value="<?php echo htmlspecialchars($_SESSION['State']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="StreetAddress" value="<?php echo htmlspecialchars($_SESSION['StreetAddress']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Surname" value="<?php echo htmlspecialchars($_SESSION['Surname']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Title" value="<?php echo htmlspecialchars($_SESSION['Title']); ?>" style="width:600px;"><br>
    </div>
    <div>
    ...
    <div>
        ...
        <input type="text" name="Type" value="<?php echo htmlspecialchars($_SESSION['Type']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="UserPrincipalName" value="<?php echo htmlspecialchars($_SESSION['UserPrincipalName']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="Confirm" value="<?php echo htmlspecialchars($_SESSION['Confirm']); ?>" style="width:600px;"><br>
    </div>
    <div>
        ...
        <input type="text" name="WhatIf" value="<?php echo htmlspecialchars($_SESSION['WhatIf']); ?>" style="width:100px;"><br>
    </div>
    <p><p><p>
