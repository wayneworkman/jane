...
if ($SessionIsVerified == "1") {
    ...
    if ($isAdministrator == 1) {
        ...
        echo "<br>";
        echo "The WHERE setting is included as part of the SQL SELECT statement used with selecting data from the <font color=\"red\">userDataToImport</font> table. Any data matching this WHERE clause will be included in processing for this group of settings. Therefore they are only available to administrators.<br>";
        echo "<br>";
