...
if ($SessionIsVerified == "1") {
	...
	if ($result->num_rows > 0) {
		...
		$_SESSION['FolderName'] = "";
		$_SESSION['ShareThisFolder'] = "";
		$_SESSION['aclAdministrators'] = "";
		$_SESSION['aclSystem'] = "";
		$_SESSION['aclOther'] = "";
		$_SESSION['DisableInheritance'] = "";
		$_SESSION['Name'] = "";
