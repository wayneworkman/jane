...
schema4() {
    ...
    local step1="ALTER TABLE usernameTracking ADD lastSeen int(11) DEFAULT 0;"
    local step2="UPDATE globalSettings SET settingValue = '5' WHERE settingKey = 'schemaVersion'"

    dots "Going from DB Schema 4 to 5"
